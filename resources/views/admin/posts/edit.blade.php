...
<section class="content">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <label>
            <input type="checkbox" class="minimal" @checked($post->is_featured) name="is_featured">
            </label>
            <label>
            Рекомендовать
            </label>
        ...
        <div class="form-group">
            <label>
            <input type="checkbox" class="minimal" @checked($post->is_published) name="is_published">
            </label>
            <label>
            Опубликовано
            </label>
